...
<form action="/admin/hotel_add" method="post">
    ...
    <div class="mb-3">
        ...
        <input type="email" class="form-control" name="hotelName" id="exampleInputEmail1" aria-describedby="emailHelp">
    ...
    <div class="mb-3">
        ...
        <input type="email" class="form-control" name="ownerName" id="exampleInputEmail2" aria-describedby="emailHelp">
    </div>
